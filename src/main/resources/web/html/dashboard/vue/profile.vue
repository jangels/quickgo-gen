...
<div class="db-profile form">
    <div class="item">
        ...
        <div class="col-sm-10">
            <div class="user-logo">
                ...
                <div class="logo-edit" title="修改头像">
                    <i class="iconfont icon-edit3"></i>
                    <input class="upload-img" type="file" v-model="uploadAvatar" @change="uploadImg" >
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="item">
        ...
        <div class="col-sm-6">{{ user.createtime | timestampFormat }}</div>
    </div>
    ...
    export default{
        ...
        methods:{
            ok:function(){
                ...
                utils.post('/user/'+this.user.id+".json",this.user,function(){
                    toastr.success('修改成功');
