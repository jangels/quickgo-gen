...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="/gen/genTemplate/form?id=${genTemplate.id}">代码模板${not empty genTemplate.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genTemplate" action="/gen/genTemplate/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
