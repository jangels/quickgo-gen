...
import com.quickgo.platform.exception.ImageData;
...
public class FileUtils {
    ...
    public static String key(String contentType) {
        return new SimpleDateFormat("yyyyMM/dd/").format(new Date()).concat(Validate.uuid()+getImageType(contentType));
    }
    ...
    public static Map<String, Object> getImageExif(String key) {
        if (ConfigUtils.getUploadServer().equals("qiniu")) {
            ...
            return null;
//            throw new Exception("exif unsupport","");
        }
    }
